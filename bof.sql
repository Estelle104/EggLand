...
TRUNCATE TABLE versementsalaire RESTART IDENTITY CASCADE;
TRUNCATE TABLE paiementsalaire RESTART IDENTITY CASCADE;
TRUNCATE TABLE detailvente RESTART IDENTITY CASCADE;
TRUNCATE TABLE livraison RESTART IDENTITY CASCADE;
TRUNCATE TABLE vente RESTART IDENTITY CASCADE;
TRUNCATE TABLE oeufstatut RESTART IDENTITY CASCADE;
TRUNCATE TABLE oeufproduction RESTART IDENTITY CASCADE;
TRUNCATE TABLE mvtstock RESTART IDENTITY CASCADE;
TRUNCATE TABLE mvtargent RESTART IDENTITY CASCADE;
TRUNCATE TABLE traitement RESTART IDENTITY CASCADE;
TRUNCATE TABLE reforme RESTART IDENTITY CASCADE;
TRUNCATE TABLE mort RESTART IDENTITY CASCADE;
TRUNCATE TABLE lot_races RESTART IDENTITY CASCADE;
TRUNCATE TABLE lot RESTART IDENTITY CASCADE;
TRUNCATE TABLE client RESTART IDENTITY CASCADE;
TRUNCATE TABLE useradmin RESTART IDENTITY CASCADE;
TRUNCATE TABLE notification RESTART IDENTITY CASCADE;
TRUNCATE TABLE configuration RESTART IDENTITY CASCADE;
TRUNCATE TABLE nourriture RESTART IDENTITY CASCADE;
TRUNCATE TABLE employe RESTART IDENTITY CASCADE;
TRUNCATE TABLE race RESTART IDENTITY CASCADE;
TRUNCATE TABLE batiment RESTART IDENTITY CASCADE;
TRUNCATE TABLE produitvente RESTART IDENTITY CASCADE;
TRUNCATE TABLE roleuser RESTART IDENTITY CASCADE;
TRUNCATE TABLE statutclient RESTART IDENTITY CASCADE;
TRUNCATE TABLE statutlivraison RESTART IDENTITY CASCADE;
TRUNCATE TABLE statutlot RESTART IDENTITY CASCADE;
TRUNCATE TABLE statutoeuf RESTART IDENTITY CASCADE;
TRUNCATE TABLE statutvente RESTART IDENTITY CASCADE;
TRUNCATE TABLE typemvt RESTART IDENTITY CASCADE;
